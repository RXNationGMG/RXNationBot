    ...
    run: async (bot, message, args) => {
        ...
        try {
            let res = await urban(args.join(' '))
                if (!res) return message.channel.send("<a:deny:892076004183506954> No results found for this topic, sorry!");
            ...
            console.log(e)
            return message.channel.send("<a:deny:892076004183506954> looks like i've broken! Try again")
        }
    }
}