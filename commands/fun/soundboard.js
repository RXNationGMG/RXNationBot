...
module.exports = {
    ...
    run: async (bot, message, args) => {
        if (!message.guild.me.hasPermission(['CONNECT', 'SPEAK'])) return message.channel.send("**<a:deny:892076004183506954> I Dont Have Permissions To Either - JOIN or SPEAK!**");
        const { channel } = message.member.voice;
        if (!channel) return message.channel.send("**<a:deny:892076004183506954> Please Join A VC To Play Sound!**");
        ...
        if (!args[0]) {
            ...
            try {
                ...
                if (connection) {
                    ...
                    return message.channel.send("**<a:deny:892076004183506954> Could Not Join VC, Try Again!**");
                }
            } catch {
                return message.channel.send("**<a:deny:892076004183506954> Something Went Wrong Try Again!**");
            }
            return null;
        } else {
            ...
            try {
                ...
                return message.channel.send("**<a:deny:892076004183506954> Couldn't Join VC, Check My Permissions!**");
            };
        };
    }
};