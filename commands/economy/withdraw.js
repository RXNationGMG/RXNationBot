    ...
    run: async (bot, message, args) => {
        ...
        if (args.join(' ').toLocaleLowerCase() == 'all') {
            ...
            let embed = new MessageEmbed()
              .setColor("RANDOM")
              .setDescription(`<a:deny:892076004183506954>**You Do Not Have Any Money To Withdraw!**`)
            if (!money) return message.channel.send(embed)
            db.subtract(`bank_${user.id}`, money)
            db.add(`money_${user.id}`, money)
            let embed5 = new MessageEmbed()
                .setColor("RANDOM")
                .setDescription(`<a:check:892071687250673664> You have withdrawn all your coins from your bank`); 
            ...
            let embed5 = new MessageEmbed()
                .setColor("RANDOM")
                .setDescription(`<a:check:892071687250673664> You have withdrawn ${args[0]} coins from your bank!`);
