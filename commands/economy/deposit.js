    ...
    run: async (bot, message, args) => {
        ...
        if (args[0] == 'all') {
            ...
            let embed3 = new MessageEmbed()
                .setColor("RANDOM")
                .setDescription(`<a:deny:892076004183506954> You can't deposit negative money`);
            ...
            let embed5 = new MessageEmbed()
                .setColor("RANDOM")
                .setDescription(`<a:check:892071687250673664> You have deposited ${args[0]} coins into your bank`);
