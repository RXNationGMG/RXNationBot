...
try {
        ...
        if (!message.guild.me.voice.channel) return message.channel.send('<a:deny:892076004183506954> **Bot is Not In A VC!**');

        if (serverQueue || serverQueue.playing) {
          serverQueue.connection.dispatcher.end();
          await channel.leave();
          return message.channel.send("**<a:check:892071687250673664>  Left The Voice Channel!**");
        } else {
        await channel.leave();
        return message.channel.send("**<a:check:892071687250673664> Left The Voice Channel!**");
        }
