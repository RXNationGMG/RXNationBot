...
module.exports = {
  ...
  run: async (bot, message, args, ops) => {
    ...
    if (!channel) return message.channel.send('<a:deny:892076004183506954> I\'m sorry but you need to be in a voice channel to see lyrics!');
    ...
    try {
      ...
      if (!songID) return message.channel.send("<a:deny:892076004183506954> not available")
      ...
      if (lyrics.length > 8192) {
        return sentMessage.edit("**<a:deny:892076004183506954> Not Availble**");
      ...
      return sentMessage.edit(
        '**<a:deny:892076004183506954> Not Available**'
      );
    }
