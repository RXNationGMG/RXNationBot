...
run: async (bot, message, args, ops) => {
        ...
        if (!channel) return message.channel.send('<a:deny:892076004183506954> I\'m sorry but you need to be in a voice channel to skip music!');
        ...
        if (!serverQueue.songs) return message.channel.send('<a:deny:892076004183506954> **There are No Songs In The Queue!');
      try {
        serverQueue.songs = [];
