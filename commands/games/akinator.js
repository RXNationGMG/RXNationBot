...
module.exports = {
	...
	run: async (bot, message, args, ops) => {
		if (!message.channel.permissionsFor(bot.user).has('EMBED_LINKS')) return message.channel.send('**<a:deny:892076004183506954> Missing Permissions - [EMBED_LINKS]!**');
		...
		try {
			...
			ops.games.delete(message.channel.id);
			return message.channel.send(`**<a:warn:891035320030724196> Server Down!, Try again later!**`);
		};
	}
};
