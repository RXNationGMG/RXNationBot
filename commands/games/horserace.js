...
const { shuffle, randomRange, drawImageWithTint } = require('../../functions.js');
...
module.exports = {
  ...
  run: async (bot, message, args) => {
    ...
    if (!messages.size) return message.channel.send('<a:deny:892076004183506954> | Sorry, can\'t have a race with no bets!');
    ...
    return message.channel.send(win ? '<a:check:892071687250673664> | Nice job! Your horse won!' : '<a:warn:891035320030724196> | Better luck next time!', { files: [leaderboard] });
