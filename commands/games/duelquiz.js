...
module.exports = {
  ...
  run: async (bot, message, args, ops) => {
    ...
    let maxPts = args[1]
    if (maxPts <= 0 || maxPts >= 9) return message.channel.send("**<a:deny:892076004183506954> Please Enter A Number Between 1-8!**")
    if (opponent.user.bot) return message.channel.send('**<a:deny:892076004183506954> Cannot Play Against Bots!**');
    ...
    try {
      ...
      ops.games.delete(message.channel.id);
      return message.channel.send("**<a:warn:891035320030724196> Trivia Not Available!**");
    }
