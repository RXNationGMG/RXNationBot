...
const Deck = require('../../structures/poker/Deck.js');
const { formatNumber, list, delay } = require('../../functions.js');
const max = 6;
const min = 2;
...
module.exports = {
    ...
    run: async (bot, message, args, ops) => {
        ...
        if (!playersCount) return message.channel.send("**<a:deny:892076004183506954> | Please Enter The Number Of Players Playing Excluding You!**")
        if (playersCount < 1 || playersCount >= 6) return message.channel.send("**<a:deny:892076004183506954> | Please Enter A Number Between 1-5!**")
        ...
        try {
            ...
            if (awaitedPlayers.length - 1 < playersCount) {
                ...
                return message.channel.send('**<a:deny:892076004183506954> | Sufficient Amount Of Players Didnt Join!**');
            }
