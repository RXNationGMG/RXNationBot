...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        if (!args[0]) return message.channel.send("<a:warn:891035320030724196> Type A Language to translate")
        ...
        try {
            ...
            const embed1 = new MessageEmbed()
                .setColor("RANDOM")
                .setDescription('**<a:deny:892076004183506954> You Did Not Enter Any Text!**')
