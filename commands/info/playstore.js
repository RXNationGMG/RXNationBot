...
module.exports = {
    ...
    run: async (bot, message, args) => {
      ...
      return message.channel.send(
        `<a:deny:892076004183506954> Please Give Something To Search - ${message.author.username}`
      );
    ...
    PlayStore.search({
      ...
      try {
        ...
        return message.channel.send(
          `<a:warn:891035320030724196> No Application Found - ${message.author.username}!`
        );
      }
