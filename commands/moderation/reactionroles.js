...
try{
    ...
    return message.reply(
      "<a:deny:892076004183506954> Im sorry but I do not have the valid permissions to give roles"
    );
  if (!message.member.hasPermission("MANAGE_ROLES"))
    return message.reply("<a:deny:892076004183506954> OI! stop right there what do u think ur doing huh!");
