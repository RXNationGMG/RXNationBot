...
module.exports = {
    ...
    run: async (bot, message, args) => {
        if (!message.guild.me.hasPermission('ATTACH_FILES')) return message.channel.send("**<a:deny:892076004183506954> Missing Permissions - [ATTACH_FILES]!**");
        ...
        if (!overlay) return message.channel.send("**<a:warn:891035320030724196> Overlay User Not Found!**");
