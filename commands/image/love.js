...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        if(!args[0]) return message.channel.send("**<a:deny:892076004183506954> Enter Name Of Lover!**")
        if(!args[1]) return message.channel.send("**<a:deny:892076004183506954> Enter Name Of Another Lover!**")
        
        if (!user) return message.channel.send("**<a:deny:892076004183506954> Please Enter A Valid User!**")
        if (!user2) return message.channel.send("**<a:deny:892076004183506954> Please Enter A Valid User!**")
